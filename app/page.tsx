...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col bg-black text-white overflow-x-hidden">
      ...
      <div ref={geminiRef} className="h-screen w-full bg-black relative pt-20 overflow-hidden">
        <div className="absolute top-4 left-20 md:left-48 z-20">
          ...
          >
            <Image src="/images/srm-logo.png" alt="SRM Logo" width={150} height={50} className="h-10 w-auto" />
          </motion.div>
        </div>
        ...
        <div className="absolute inset-x-0 top-[25%] z-10 overflow-visible">
          <GoogleGeminiEffect
      ...
      {/* Experiments Section */}
      <div ref={experimentsRef} id="experiments" className="w-full py-16 md:py-24 bg-black mt-20">
